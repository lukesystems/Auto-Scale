...
const NAV_ITEMS = [
  ...
  { key: "signals", href: "/signals", label: "Signals", icon: TrendingUp, step: 4 },
  { key: "trendwatch", href: "/trendwatch", label: "TrendWatch", icon: Brain, step: 5 },
  { key: "ideas", href: "/ideas", label: "Ideas", icon: Lightbulb, step: 6 },
  { key: "content", href: "/content", label: "Content", icon: Layers, step: 7 },
  { key: "approval", href: "/approval", label: "Approval", icon: Shield, step: 8 },
  { key: "exports", href: "/exports", label: "Exports", icon: Package, step: 9 },
  { key: "schedule", href: "/schedule", label: "Schedule", icon: Send, step: 10 },
  { key: "experiments", href: "/experiments", label: "Experiments", icon: FlaskConical, step: 11 },
  { key: "winners", href: "/winners", label: "Winners", icon: Trophy, step: 12 },
] as const;
